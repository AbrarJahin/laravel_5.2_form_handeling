                        ...
                        <div class="wagon mb-70 mt-50">
                            <div class="wagon-body">
                                <div class="other-note-holder @if($errors->has('other_notes')) has-error has-feedback @endif">
                                    ...
                                    <textarea required name="other_notes" class="form-control stk2" placeholder="Company Address">@if(Request::old('other_notes')){{Request::old('other_notes')}}@elseif ( isset($current_hosting) && !empty($current_hosting) ){{ $current_hosting->other_notes }}@endif</textarea>
