    ...
    <div class="wagon-body">
        ...
        <div class="form-group">
            ...
            <div class="col-sm-8 @if($errors->has('hosting_details')) has-error has-feedback @endif">
                <textarea required name="hosting_details" class="form-control stk2" placeholder="Company Address">@if(Request::old('hosting_details')){{Request::old('hosting_details')}}@elseif ( isset($current_hosting) && !empty($current_hosting) ){{ $current_hosting->hosting_details }}@endif</textarea>
